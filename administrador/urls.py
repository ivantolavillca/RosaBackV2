...
from conforme_con_cuerpo.api.router import router_conforme_de_cuerpo
from consumo_alcohol.api.router import router_consumo_alcohol
from consumo_frutas_verduras.api.router import router_consumo_frutas_verduras
from entorno_social.api.router import router_entorno_social
from habitos_alimentarios.api.router import router_habitos_alimentarios
from horas_de_sueno.api.router import router_horas_de_sueno
...
urlpatterns = [
    ...
    path('api/', include(router_consumo_frutas_verduras.urls)),
    path('api/', include(router_consumo_alcohol.urls)),
    path('api/', include(router_horas_de_sueno.urls)),
    path('api/', include(router_conforme_de_cuerpo.urls)),
    path('api/', include(router_tipo_de_transporte.urls)),
    ...
    path('api/test-api-verify/', TestApicheck.as_view(), name='test-api-verify'),
]
