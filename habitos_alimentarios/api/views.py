...
from habitos_alimentarios.api.permissions import IsAdminOrReadOnly
...
class HabitosAlimentariosApiViewSet(ModelViewSet):
    permission_classes = [IsAdminOrReadOnly]
    queryset = habitos_alimentarios.objects.filter(is_delete=False)
    serializer_class = HabitosAlimentariosSerializer
